...
axes[0].imshow(lightning_img, interpolation='none')

axes[1].imshow(lightning_img, interpolation='none')
...
lightning_img.paste(water, (730, 950), mask=water) 

fig3, axes3 = plt.subplots(1, 2)
axes3[0].imshow(lightning_img, interpolation='none')
axes3[1].imshow(lightning_img, interpolation='none')
